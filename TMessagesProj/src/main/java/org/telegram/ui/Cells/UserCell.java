...
public class UserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, Theme.Colorable {
    ...
    public void setCallCellStyle(int padding) {
        ...
        avatarImageView.setRoundRadius(org.telegram.messenger.AvatarCornerHelper.getAvatarRoundRadius(44.0f));
    ...
    public void update(int mask) {
        ...
        avatarImageView.setRoundRadius(isCommunity ? dp(46 * 20 / 72f) : org.telegram.messenger.AvatarCornerHelper.getAvatarRoundRadius(
                46.0f,
                currentChat != null && currentChat.forum,
                currentChat != null && currentChat.forum && MessagesController.getInstance(currentAccount).getStoriesController().hasStories(dialogId)
        ));
