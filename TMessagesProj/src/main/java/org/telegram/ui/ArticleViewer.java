...
//                    ObjectAnimator.ofFloat(pages[1], View.ALPHA, 1.0f, 0.0f)
    ...
    public static TL_iv.RichText getLastRichText(TL_iv.RichText richText) {
        ...
        if (richText instanceof TL_iv.textFixed) {
            ...
            return getLastRichText(((TL_iv.textAnchor) richText).text);
        } else if (richText instanceof TL_iv.textSubscript) {
    ...
    public static CharSequence getText(
        ...
        if (richText instanceof TL_iv.textFixed) {
            ...
            WebpageAdapter adapter = parent != null ? parent.getAdapter() : null;
    ...
    private void updatePaintFonts() {
        ...
        for (int a = 0; a < resources.quoteTextPaints.size(); a++) {
            updateFontEntry(resources.quoteTextPaints.keyAt(a), resources.quoteTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.preformattedTextPaints.size(); a++) {
            updateFontEntry(resources.preformattedTextPaints.keyAt(a), resources.preformattedTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.paragraphTextPaints.size(); a++) {
            updateFontEntry(resources.paragraphTextPaints.keyAt(a), resources.paragraphTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.listTextPaints.size(); a++) {
            updateFontEntry(resources.listTextPaints.keyAt(a), resources.listTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.embedPostTextPaints.size(); a++) {
            updateFontEntry(resources.embedPostTextPaints.keyAt(a), resources.embedPostTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.mediaCaptionTextPaints.size(); a++) {
            updateFontEntry(resources.mediaCaptionTextPaints.keyAt(a), resources.mediaCaptionTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.mediaCreditTextPaints.size(); a++) {
            updateFontEntry(resources.mediaCreditTextPaints.keyAt(a), resources.mediaCreditTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.photoCaptionTextPaints.size(); a++) {
            updateFontEntry(resources.photoCaptionTextPaints.keyAt(a), resources.photoCaptionTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.photoCreditTextPaints.size(); a++) {
            updateFontEntry(resources.photoCreditTextPaints.keyAt(a), resources.photoCreditTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.authorTextPaints.size(); a++) {
            updateFontEntry(resources.authorTextPaints.keyAt(a), resources.authorTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.footerTextPaints.size(); a++) {
            updateFontEntry(resources.footerTextPaints.keyAt(a), resources.footerTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.embedPostCaptionTextPaints.size(); a++) {
            updateFontEntry(resources.embedPostCaptionTextPaints.keyAt(a), resources.embedPostCaptionTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.relatedArticleTextPaints.size(); a++) {
            updateFontEntry(resources.relatedArticleTextPaints.keyAt(a), resources.relatedArticleTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.detailsTextPaints.size(); a++) {
            updateFontEntry(resources.detailsTextPaints.keyAt(a), resources.detailsTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
        for (int a = 0; a < resources.tableTextPaints.size(); a++) {
            updateFontEntry(resources.tableTextPaints.keyAt(a), resources.tableTextPaints.valueAt(a), typefaceNormal, typefaceBoldItalic, typefaceBold, typefaceItalic);
        }
    }
    ...
    private void updatePaintColors(IArticleViewer parent) {
...
//                            collapseButton.setVisibility(View.INVISIBLE);
    ...
    public class WebpageAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public HashMap<Object, TL_iv.PageBlock> textToBlocks = new HashMap<>();
        ...
        private void bindBlockToHolder(int type, RecyclerView.ViewHolder holder, TL_iv.PageBlock block, int position, int total, boolean calcHeight) {
            ...
            switch (type) {
                ...
                case 9: {
                    ...
                    cell.setBlock((TL_iv.pageBlockPhoto) block, currentPage.cached_page, null, calcHeight, position == 0);
                ...
                case 23: {
                    ...
                    cell.setBlock((TL_pageBlockRelatedArticlesChild) block, currentPage.cached_page);
                    break;
                }
                case 24: {
