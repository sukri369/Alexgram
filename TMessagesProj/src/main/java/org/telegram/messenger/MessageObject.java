...
public class MessageObject {
    ...
    public boolean updateTranslation(boolean force) {
        ...
        if (showSummarizedTranslated) {
            ...
            messageOwner != null &&
            (TranslateController.isTranslatable(this) || manualTranslated) &&
            (manualTranslated || (translateController.isTranslatingDialog(getDialogId()) && !translateController.isTranslateDialogHidden(getDialogId()))) &&
            (translatedText != null || messageOwner.translatedPoll != null || messageOwner.translatedRichMessage != null) &&
            (manualTranslated || TextUtils.equals(translateController.getDialogTranslateTo(getDialogId()), messageOwner.translatedToLanguage))
        ) {
