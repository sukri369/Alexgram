...
public class SettingsSearchManager {
    ...
    private void loadIndex() {
        ...
        add("Hidden Chats", "Secure your private conversations with a passcode", "hidden_chats", NekoSettingsActivity.class, "Privacy", R.drawable.msg_lock);
        ...
        add("Font & Typeface", "Change the global font family of the application", "typeface", NekoGeneralSettingsActivity.class, "General", R.drawable.msg_font);
        add("Blur Effects", "Toggle glassmorphism and blur in various UI sections", "forceBlurInChat", NekoGeneralSettingsActivity.class, "General", R.drawable.msg_blur_solar);
        ...
        add("AI Background Animation", "Toggle the animated background in AI settings", "background_animation", AIAssistanceSettingsActivity.class, "AI", R.drawable.msg_animations);
        add("Particle Effects", "Show dynamic particles on AI interaction", "particle_effects", AIAssistanceSettingsActivity.class, "AI", R.drawable.msg_blur_solar);
        ...
        add("Hide Keyboard on Scroll", "Dismiss the keyboard when swiping through messages", "HideKeyboardOnScroll", NekoChatSettingsActivity.class, "Chats", R.drawable.msg_keyboard);
        add("Message Menu Animations", "Staggered 1-by-1 animations for context menus", "MenuAnimations", NekoChatSettingsActivity.class, "Chats", R.drawable.msg_animations);
        ...
        add("Online Status", "Show user online status in chat headers", "ShowOnlineStatus", NekoChatSettingsActivity.class, "Chats", R.drawable.msg_status_online);
        add("Double Tap Action", "Customize what happens on message double tap", "DoubleTapIncoming", NekoChatSettingsActivity.class, "Chats", R.drawable.msg_reply);
        ...
        // --- MEDIA & CHANNELS ---
        add("Auto-Play Voice", "Automatically play sequential voice messages", "DontAutoPlayNextVoice", NekoChatSettingsActivity.class, "Media", R.drawable.msg_voice);
